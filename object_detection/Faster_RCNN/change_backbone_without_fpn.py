...
def create_model(num_classes):
    ...
    # # print(backbone)
    # backbone = create_feature_extractor(backbone, return_nodes={"layer3": "0"}) # 这个方法对 backbone 进行了封装，输出指定层的输出 
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='/home/znk/Datasets/VOC', help='dataset')
    # 检测目标类别数(不包含背景)
