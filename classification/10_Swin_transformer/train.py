...
from model import swin_tiny_patch4_window7_224, swin_base_patch4_window7_224
...
def get_config():
    ...
    parser.add_argument("--batch_size", type=int, help="batch size", default=8, required=False)
    ...
    parser.add_argument("--freeze_features", help="if freeze features layer before mlp head", action="store_true", required=False)
