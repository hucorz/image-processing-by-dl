...
from model_v2 import shufflenet_v2_x1_0
...
def get_config():
    ...
    parser.add_argument("--freeze_linear", help="if freeze layers weight, defalut False", action="store_true", required=False)
...
def main(config):
    ...
    model = shufflenet_v2_x1_0(num_class)
